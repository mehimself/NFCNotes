<template>
  <div class="logo"
    ...
    <v-flex
      ...
      <div class="cube show-top" :style="{width: size + 'em', height: size + 'em', marginLeft: size / 2 + 'em', marginTop: size / 2 + 'em'}">
...
<style>
  ...
  .logo .cube figure.face {
    display: block;
    position: absolute;
    background-size: cover; /* 100% 100%; */
    background-image: url('/logo/data.gif'); /* http://2.bp.blogspot.com/-X6ZN9ZMytgI/VLHS9_plpBI/AAAAAAAAACM/ibMJvIZ2-44/s1600/image.gif); */
  }
